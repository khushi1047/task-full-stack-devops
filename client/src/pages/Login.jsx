    ...
    <div className="min-h-screen flex items-center justify-center bg-black py-10">
      <div className="w-[350px] bg-[#111111] border border-purple-300 rounded-xl p-8 shadow-lg shadow-purple-500/20">
        ...
        <input
          ...
          className="w-full mb-2 px-4 py-3 bg-[#1a1a1a] border border-purple-400 rounded-lg text-purple-100 placeholder-purple-300 focus:outline-none focus:border-purple-300 focus:ring-2 focus:ring-purple-500"
        />
        ...
        <p className="text-purple-300 text-center mt-4">
          ...
          <Link to="/SignUp" className="text-purple-200 font-semibold hover:underline">
            Sign Up
          </Link>
        </p>
      </div>
